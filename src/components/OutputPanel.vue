  ...
  <div class="p-4 bg-white rounded-lg shadow">
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p v-if="content.trim() && !isCreationMode" class="text-sm text-gray-600">
          {{ templateCount }} {{ language === 'xml' ? 
      ...
      <div class="flex items-center space-x-4">
        ...
        />
        <OutputToggle
          v-if="language === 'vscode-snippet' && content.trim()"
